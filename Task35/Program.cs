...
int[] arr = CreateArray(123, 1, 200);
PrintArray(arr);

int returnNumber = ReturnNumberElements(arr, 10, 99);
Console.WriteLine($" количество элементов массива в отрезке 10-99: {returnNumber} ");
